  ...
  return (
    <header className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-pink-50">
      ...
      <ScrollReveal direction="up" delay={200}>
        <div className="relative z-10 text-center text-white drop-shadow-lg px-8 py-6 bg-white/0 backdrop-blur-[4px] rounded-2xl border border-white/10 shadow-[0_4px_60px_rgba(255,255,255,0.1)]">
          <p className="text-3xl font-['Great_Vibes'] text-pink-200 mb-3 animate-fade-in">
            Save The Date
          </p>

          <h1 className="text-2xl md:text-6xl font-playfair font-semibold bg-gradient-to-r from-pink-200 via-white to-pink-100 bg-clip-text text-transparent animate-slide-up">
